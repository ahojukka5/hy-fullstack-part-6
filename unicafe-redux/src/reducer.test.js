...
describe('unicafe reducer', () => {
  ...
  test('increases good by one when GOOD action is given', () => {
  ...
  test('increases ok by one when OK action is given', () => {
  ...
  test('increases bad by one when BAD action is given', () => {
  ...
  test('resets state when ZERO action is given', () => {
